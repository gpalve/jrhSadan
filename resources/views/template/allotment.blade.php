...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F221972165805459" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F221972165805459" title="oEmbed Form">
<meta property="og:title" content="Attendant for Patient Admitted in JRH" >
<meta property="og:url" content="https://form.jotform.com/221972165805459" >
<meta property="og:description" content="Please click the link to complete this form." >
<meta name="slack-app-id" content="AHNMASS8M">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/assets/img/favicons/favicon-2021.svg">
<link rel="canonical" href="https://form.jotform.com/221972165805459" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" />
<meta name="HandheldFriendly" content="true" />
<title>Attendant for Patient Admitted in JRH</title>
...
<link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/css/styles/payment/payment_styles.css?3.3.34550" />
<link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.34550" />
...
<script src="https://cdn01.jotfor.ms/static/prototype.forms.js?3.3.34550" type="text/javascript"></script>
<script src="https://cdn02.jotfor.ms/static/jotform.forms.js?3.3.34550" type="text/javascript"></script>
...
if (window.JotForm && JotForm.accessible) $('input_26').setAttribute('tabindex',0);
   ...
   JotForm.prepareCalculationsOnTheFly([null,{"name":"clickTo","qid":"1","text":"ALLOTMENT LETTER ","type":"control_head"},null,{"description":"","name":"fullName3","qid":"3","text":"Patients Details","type":"control_fullname"},null,null,{"description":"","name":"email6","qid":"6","subLabel":"example@example.com","text":"E-mail","type":"control_email"},null,null,null,null,null,null,null,null,{"description":"","name":"patientsRoom","qid":"15","text":"Patients Room \u002F Ward Details","type":"control_fullname"},null,{"description":"","name":"attendantsDetails17","qid":"17","text":"Attendants Details","type":"control_fullname"},null,{"description":"","name":"attendantsParticulars","qid":"19","text":"Attendants Particulars","type":"control_fullname"},null,null,null,null,{"name":"allotmentLetter","qid":"24","text":"For Medical Director","type":"control_head"},null,{"description":"","name":"diagnosedFor","qid":"26","subLabel":"","text":"Diagnosed for","type":"control_textarea"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"clickTo","qid":"1","text":"ALLOTMENT LETTER ","type":"control_head"},null,{"description":"","name":"fullName3","qid":"3","text":"Patients Details","type":"control_fullname"},null,null,{"description":"","name":"email6","qid":"6","subLabel":"example@example.com","text":"E-mail","type":"control_email"},null,null,null,null,null,null,null,null,{"description":"","name":"patientsRoom","qid":"15","text":"Patients Room \u002F Ward Details","type":"control_fullname"},null,{"description":"","name":"attendantsDetails17","qid":"17","text":"Attendants Details","type":"control_fullname"},null,{"description":"","name":"attendantsParticulars","qid":"19","text":"Attendants Particulars","type":"control_fullname"},null,null,null,null,{"name":"allotmentLetter","qid":"24","text":"For Medical Director","type":"control_head"},null,{"description":"","name":"diagnosedFor","qid":"26","subLabel":"","text":"Diagnosed for","type":"control_textarea"}]);}, 20); 
</script>
</head>
<body>
  
<form class="jotform-form" action="https://submit.jotform.com/submit/221972165805459/" method="post" name="form_221972165805459" id="221972165805459" accept-charset="utf-8" autocomplete="on">
  <input type="hidden" name="formID" value="221972165805459" />
    ...
    <ul class="form-section page-section">
      <li id="cid_1" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-large">
          <div class="header-text httac htvam">
            ...
            <div id="subHeader_1" class="form-subHeader" data-layout="full">
              FOR JRH PATIENTS ATTENDANTS 
            </div>
          </div>
        </div>
      </li>
        ...
        <div id="cid_3" class="form-input jf-required" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_3" name="q3_fullName3[first]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_3 given-name" size="10" value="{{$customer->name}}" data-component="first" aria-labelledby="label_3 sublabel_3_first" required="" />
              <label class="form-sub-label" for="first_3" id="sublabel_3_first" style="min-height:13px" aria-hidden="false"> Name </label>
            </span>
        
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_fullname" id="id_15" data-compound-hint=",,">
        <label class="form-label form-label-top form-label-extended form-label-auto" id="label_15" for="first_15">
          Patients Room / Ward Details
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_15" class="form-input-wide jf-required" data-layout="full">
          <div data-wrapper-react="true" class="extended">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_15" name="q15_patientsRoom[first]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_15 given-name" size="10" value="{{$customer->ward}}" data-component="first" aria-labelledby="label_15 sublabel_15_first" required="" />
              <label class="form-sub-label" for="first_15" id="sublabel_15_first" style="min-height:13px" aria-hidden="false"> Ward Number of Patient </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="middle">
              <input type="text" id="middle_15" name="q15_patientsRoom[middle]" class="form-textbox" data-defaultvalue="" autoComplete="section-input_15 additional-name" size="10" value="{{$customer->cot}}" data-component="middle" aria-labelledby="label_15 sublabel_15_middle" required="" />
              <label class="form-sub-label" for="middle_15" id="sublabel_15_middle" style="min-height:13px" aria-hidden="false"> Cot Number of Patient </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
              <input type="text" id="last_15" name="q15_patientsRoom[last]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_15 family-name" size="15" value="{{$customer->umid}}" data-component="last" aria-labelledby="label_15 sublabel_15_last" required="" />
              <label class="form-sub-label" for="last_15" id="sublabel_15_last" style="min-height:13px" aria-hidden="false"> UMID Card Number of Patient </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_textarea" id="id_26">
        <label class="form-label form-label-left form-label-auto" id="label_26" for="input_26"> Diagnosed for </label>
        <div id="cid_26" class="form-input" data-layout="full">
          <textarea id="input_26" class="form-textarea" name="q26_diagnosedFor" style="width:648px;height:40px" data-component="textarea" aria-labelledby="label_26">{{$customer->diagnosis}}</textarea>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_fullname" id="id_19">
        ...
        <div id="cid_19" class="form-input jf-required" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_19" name="q19_attendantsParticulars[first]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_19 given-name" size="10" value="{{$customer->pname}}" data-component="first" aria-labelledby="label_19 sublabel_19_first" required="" />
              <label class="form-sub-label" for="first_19" id="sublabel_19_first" style="min-height:13px" aria-hidden="false">Name </label>
            </span>
            
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_fullname" id="id_17" data-compound-hint=",,">
        <label class="form-label form-label-top form-label-extended form-label-auto" id="label_17" for="first_17">
          Other Details
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_17" class="form-input-wide jf-required" data-layout="full">
          <div data-wrapper-react="true" class="extended">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_17" name="q17_attendantsDetails17[first]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_17 given-name" size="10" value="9892409070" data-component="first" aria-labelledby="label_17 sublabel_17_first" required="" />
              <label class="form-sub-label" for="first_17" id="sublabel_17_first" style="min-height:13px" aria-hidden="false"> Mobile Number </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="middle">
              <input type="text" id="middle_17" name="q17_attendantsDetails17[middle]" class="form-textbox" data-defaultvalue="" autoComplete="section-input_17 additional-name" size="10" value="{{$mrNo->price}}" data-component="middle" aria-labelledby="label_17 sublabel_17_middle" required="" />
              <label class="form-sub-label" for="middle_17" id="sublabel_17_middle" style="min-height:13px" aria-hidden="false"> MR Number </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
              <input type="text" id="last_17" name="q17_attendantsDetails17[last]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_17 family-name" size="15" value="{{Date('d-m-Y')}}" data-component="last" aria-labelledby="label_17 sublabel_17_last" required="" />
              <label class="form-sub-label" for="last_17" id="sublabel_17_last" style="min-height:13px" aria-hidden="false"> Date </label>
            </span>
          </div>
        </div>
      </li>
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="221972165805459" />
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='221972165805459'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  all_spc[i].value = "221972165805459-221972165805459";
}
  </script>

</form></body> 
</html>
<script src="https://cdn.jotfor.ms//js/vendor/smoothscroll.min.js?v=3.3.34550"></script>
<script src="https://cdn.jotfor.ms//js/errorNavigation.js?v=3.3.34550"></script>
