...
@section('content')
    ...
    <div class="container">
        <div class="row vertical-center">
            <div class="col-lg-4 col-md-8 col-sm-12  mx-auto" style="z-index: 1">
               
                <div class="glassmorphism card-signin my-3">
                    
                    <center><img src="/img/logo/login.png" width="70%" class="mt-3" /> </center>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <h5 class="card-title text-center"> <b><p style="font-size:35px;font-family:Franklin Gothic Demi"><strong>T-55 & Parichar Sadan <br> Booking System</strong></p></b></h5>
